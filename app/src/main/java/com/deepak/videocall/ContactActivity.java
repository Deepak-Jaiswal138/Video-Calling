    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findPeopleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ContactActivity.this,FindPeopleActivity.class));
            }
        });
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()){
                ...
                case R.id.navigation_settings:
                    Intent settingIntent=new Intent(ContactActivity.this,SettingsActivity.class);
                ...
                case R.id.navigation_logout:
                    ...
                    Intent logoutIntent=new Intent(ContactActivity.this,RegistrationActivity.class);
